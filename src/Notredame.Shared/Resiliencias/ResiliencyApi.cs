namespace Notredame.Shared.Resiliencias;

public class ResiliencyApi
{
    public static void ResilienceViaCep(ResilienceHandlerContext context, ResiliencePipelineBuilder<HttpResponseMessage> builder)
        {
            var logger = context
                .ServiceProvider
